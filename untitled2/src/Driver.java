...
//                        }
    ...
    private static void loadCustomers() throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
        System.out.println( Bank.clients = (ArrayList<Client>) objectInputStream.readObject());
        objectInputStream.close();
        fileInputStream.close();
    ...
    private static void loadPeople() throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
        System.out.println(Person.persons = (ArrayList<Person>) objectInputStream.readObject());
        objectInputStream.close();
        fileInputStream.close();
